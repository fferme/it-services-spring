...
import com.ferme.itservices.api.entities.dtos.mappers.OrderItemMapper;
import com.ferme.itservices.api.entities.dtos.mappers.OrderMapper;
...
public class OrderService implements GenericCRUDService<OrderDTO, UUID> {
	...
	public OrderDTO findById(@NotNull UUID id) {
